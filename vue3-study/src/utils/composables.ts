import { ref, onMounted, onUnmounted, toValue, watchEffect, type Ref } from 'vue';
import { sleep } from 'slitu';

const useEventListener = (target: any, event: any, callback: (e: any) => void) => {
...
// 非响应函数
export const getUrl = (url: Ref<string>) => {
...
// 接收响应式状态
export const useUrl = (url: Ref<string>) => {
